...
// Purpose of file: Advanced Polls User Frontend
// ----------------------------------------------------------------------
...
function advanced_polls_user_main() 
{
	...
	return $pnRender->fetch('advancedpollsusermain.htm');
}
...
function advanced_polls_user_view() 
{
	...
	// Return the output that has been generated by this function
	return $pnRender->fetch('advancedpollsuserview.htm');
}
...
function advanced_polls_user_display($args) 
{
	...
	if (pnSecAuthAction(0, 'advanced_polls::item', "$item[pn_title]::$item[pn_pollid]", ACCESS_READ)) {
		...
		if ($displayvotingform) {
			...
			$template = 'advancedpollsuservotingform';
			...
			$template = 'advancedpollsuserresults';
			...
			$template = 'advancedpollsuserfuturepoll';
		} else {
