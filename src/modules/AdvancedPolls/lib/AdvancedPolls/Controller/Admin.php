...
public function create()
{
    ...
    $pollid = ModUtil::apiFunc('advanced_polls', 'admin', 'create', $poll);
    ...
    return System::redirect(ModUtil::url('advanced_polls', 'admin', 'modify', array('pollid' => $pollid)));
}
...
public function modify()
{
    ...
    // get vote counts
    $votecount = ModUtil::apiFunc('advanced_polls', 'user', 'pollvotecount', array('pollid' => $pollid));
...
public function update()
{
    ...
    // The API function is called.
    if (ModUtil::apiFunc('advanced_polls', 'admin', 'update', $poll)) {
...
public function delete()
{
    ...
    // The API function is called.
    if (ModUtil::apiFunc('advanced_polls', 'admin', 'delete', array('pollid' => $pollid))) {
...
public function view($args)
{
    ...
    $items = ModUtil::apiFunc('advanced_polls', 'user', 'getall', array('checkml' => false,
                                                                    'startnum' => $startnum,
    ...
    foreach ($items as $key => $item) {
        ...
        $items[$key]['isopen'] = ModUtil::apiFunc('advanced_polls', 'user', 'isopen', array('pollid' => $item['pollid']));
        $options = array();
        if (SecurityUtil::checkPermission('advanced_polls::item', "$item[title]::$item[pollid]", ACCESS_EDIT)) {
            $options[] = array('url' => ModUtil::url('advanced_polls', 'admin', 'modify', array('pollid' => $item['pollid'])),
                               'image' => 'xedit.gif',
                               'title' => __('Edit', $dom));
            if (SecurityUtil::checkPermission('advanced_polls::item', "$item[title]::$item[pollid]", ACCESS_DELETE)) {
                $options[] = array('url' => ModUtil::url('advanced_polls', 'admin', 'delete', array('pollid' => $item['pollid'])),
                               'image' => '14_layer_deletelayer.gif',
                               'title' => __('Delete', $dom));
            }
            $options[] = array('url' => ModUtil::url('advanced_polls', 'admin', 'resetvotes', array('pollid' => $item['pollid'])),
                               'image' => 'undo.gif',
                               'title' => __('Reset votes', $dom));
            $options[] = array('url' => ModUtil::url('advanced_polls', 'admin', 'duplicate', array('pollid' => $item['pollid'])),
                               'image' => 'editcopy.gif',
                               'title' => __('Duplicate poll', $dom));
            $options[] = array('url' => ModUtil::url('advanced_polls', 'admin', 'adminstats', array('pollid' => $item['pollid'])),
                               'image' => 'smallcal.gif',
...
public function modifyconfig()
{
    ...
    $this->view->assign(ModUtil::getVar('advanced_polls'));
...
public function updateconfig()
{
    ...
    ModUtil::setVar('advanced_polls', 'usereversedns', $config['usereversedns']);

    if (!isset($config['scalingfactor'])) {
        $config['scalingfactor'] = 4;
    }
    ModUtil::setVar('advanced_polls', 'scalingfactor', $config['scalingfactor']);

    if (!isset($config['cssbars'])) {
        $config['cssbars'] = 0;
    }
    ModUtil::setVar('advanced_polls', 'cssbars', $config['cssbars']);

    if (!isset($config['adminitemsperpage'])) {
        $config['adminitemsperpage'] = 25;
    }
    ModUtil::setVar('advanced_polls', 'adminitemsperpage', $config['adminitemsperpage']);

    if (!isset($config['defaultcolour'])) {
        $config['defaultcolour'] = '#000000';
    }
    ModUtil::setVar('advanced_polls', 'defaultcolour', $config['defaultcolour']);

    if (!isset($config['defaultoptioncount'])) {
        $config['defaultoptioncount'] = '12';
    }
    ModUtil::setVar('advanced_polls', 'defaultoptioncount', $config['defaultoptioncount']);
    ...
    ModUtil::setVar('advanced_polls', 'enablecategorization', $config['enablecategorization']);
